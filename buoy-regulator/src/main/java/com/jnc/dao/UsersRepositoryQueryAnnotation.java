...
public interface UsersRepositoryQueryAnnotation extends Repository<Users, Integer> {
	 ...
	 * @return
	 */
	@Query(value="select top 1 * from tb_users where users_mac_address=? order by users_into_date DESC",nativeQuery=true)
	List<Users> queryByMacAddressUseSQL(String MacAddress);
